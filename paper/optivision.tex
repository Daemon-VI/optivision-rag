...
(ColPali) on the same $60$ pages with the code's glyphs at the stated size; the
ColSmol rows re-render only those glyphs, the ColPali $3\times$ row was
rendered with the code in the text flow, which also shifts the lines below it.
...
$2\sigma$ flip ($0.4\%$), against $32$--$38\%$ below $0.5\sigma$. The ColPali run with the
